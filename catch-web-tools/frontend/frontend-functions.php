...
function cwt_styles_enqueue_styles()
{
	wp_enqueue_style('cwt-styles', CATCHWEBTOOLS_URL . 'css/cwt-styles.css', false, '1');
}
add_action('wp_enqueue_scripts', 'cwt_styles_enqueue_styles');
