...
class Catchwebtools_To_Top_Admin
{
	...
	public function customize_register($wp_customize)
	{
		...
		$wp_customize->add_control('catchwebtools_to_top_options[style]', array(
			...
			'type'     			=> 'select',
			'choices'			=> array(
				'icon'              => esc_html__('Icon Using Dashicons', 'catch-web-tools'),
				'genericon-icon'    => esc_html__('Icon Using Genericons', 'catch-web-tools'),
				'font-awesome-icon' => esc_html__('Icon Using Font Awesome Icons', 'catch-web-tools'),
				'image'             => esc_html__('Image', 'catch-web-tools')
			),
			'active_callback'	=> array($this, 'catchwebtools_to_top_enabled'),
		));
